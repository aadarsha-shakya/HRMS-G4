<?php include('../user/header.php'); 
    if(isset($_SESSION['addadmin'])) //Checking whether the SEssion is Set of Not
    {
        echo $_SESSION['addadmin']; //Display the SEssion Message if SEt
        ...
        <form action="" method="POST">
            ...
            <table class="tbl-30">
                    ...
                    <td>
                        <select name="category">
                            ...
                            <?php 
                                ...
                                $sql = "SELECT * FROM tbl_employeetype";
                ...
                <tr>
                    <td>Is Admin?: </td>
                    <td>
                        <input type="checkbox" name="is_admin" value="1"> Yes
                    </td>
                </tr>
